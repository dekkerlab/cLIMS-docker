...
##cp to amazon here
aws s3 cp $SQLFILE  s3://dekkerlab-web/db-backups/${now_s3}.sql.txt &> /home/ubuntu/aws_backup_result.txt
#rm the file
rm $SQLFILE
#BACKUP the media files
aws s3 sync /home/ubuntu/media s3://dekkerlab-web/media-backups
