...
#     url(r'^$', RedirectView.as_view(pattern_name='login',permanent=False)),
    ...
    url(r'^detailPublication/(?P<pub_pk>[0-9]+)/$', DetailPublication.as_view(), name='detailPublication'),
    url(r'^detailProtocol/(?P<protocol_pk>[0-9]+)/$', DetailProtocol.as_view(), name='detailProtocol'),
    url(r'^detailDocument/(?P<doc_pk>[0-9]+)/$', DetailDocument.as_view(), name='detailDocument'),
    url(r'^detailEnzyme/(?P<enz_pk>[0-9]+)/$', DetailEnzyme.as_view(), name='detailEnzyme'),
    url(r'^detailConstruct/(?P<construct_pk>[0-9]+)/$', DetailConstruct.as_view(), name='detailConstruct'),
    url(r'^detailGenomicRegions/(?P<genreg_pk>[0-9]+)/$', DetailGenomicRegions.as_view(), name='detailGenomicRegions'),
    url(r'^detailTarget/(?P<target_pk>[0-9]+)/$', DetailTarget.as_view(), name='detailTarget'),
