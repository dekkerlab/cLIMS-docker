...
class SeqencingFile(models.Model):
    ...
    sequencingFile_name = models.CharField(max_length=300, null=False, default="", unique=True, db_index=True)
    ...
    flowcell_details_chunk = models.CharField(max_length=500, null=True, blank=True, default="", help_text="The file chunk label as assigned by Illumina software when splitting up a \
...
class FileSet(models.Model):
    fileSet_name = models.CharField(max_length=300, null=False, default="", unique=True, db_index=True, validators=[alphanumeric])
    ...
    fileset_description = models.TextField(max_length=500, null=True, blank=True)
    contributing_labs = models.ManyToManyField('organization.ContributingLabs', blank=True, help_text="Contributing labs for this set.")
    def __str__(self):
        return self.fileSet_name


class Analysis(models.Model):
    analysis_name = models.CharField(max_length=300, null=False, default="", unique=True, db_index=True, validators=[alphanumeric])
    ...
    contributing_labs = models.ManyToManyField('organization.ContributingLabs', blank=True, help_text="Contributing labs for this analysis.")
    def __str__(self):
